...
const hardscape: Asset[] = [
  ...
  },
  {
    ...
    type: "rock",
    name: "Lava Rock",
    description: "Porous texture",
    src: "https://images.unsplash.com/photo-1628196237219-9d0ab2abeee1?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
    defaultWidth: 90,
    defaultHeight: 70
  },
  {
    ...
    type: "wood",
    name: "Spider Wood",
    description: "Branching wood",
    src: "https://images.unsplash.com/photo-1556797957-4ecfecf00d14?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
    defaultWidth: 180,
    defaultHeight: 120
  },
  {
    ...
    type: "wood",
    name: "Mopani Wood",
    description: "Dense hardwood",
    src: "https://images.unsplash.com/photo-1596461010780-8b061c7d4dfa?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
    defaultWidth: 150,
    defaultHeight: 100
  },
  {
  ...
  },
  {
    ...
    src: "https://images.unsplash.com/photo-1533577116850-9cc66cad8a9b?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
    defaultWidth: 80,
    defaultHeight: 60
  },
  {
    ...
    type: "wood",
    name: "Bogwood",
    description: "Dark and dense",
    src: "https://images.unsplash.com/photo-1555849424-7f6a4cb1c556?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
    defaultWidth: 160,
    defaultHeight: 100
  }
];
...
const plants: Asset[] = [
  ...
  },
  {
    ...
    src: "https://images.unsplash.com/photo-1530403738287-b3ee4dd3cdb7?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
    defaultWidth: 80,
    defaultHeight: 70
  },
  {
    ...
    src: "https://images.unsplash.com/photo-1618871736709-0843f4cfc85b?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
    defaultWidth: 120,
    defaultHeight: 180
  },
  {
  ...
  },
  {
    ...
    name: "Monte Carlo",
    description: "Carpet plant",
    src: "https://images.unsplash.com/photo-1605856585652-111b6a678c53?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
    defaultWidth: 150,
    defaultHeight: 30
  },
  {
...
const fish: Asset[] = [
  {
    ...
    src: "https://images.unsplash.com/photo-1535591587411-ab1de53328ab?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
    defaultWidth: 40,
    defaultHeight: 20
  },
  {
    ...
    type: "medium",
    name: "Betta",
    description: "Solitary fish",
    src: "https://images.unsplash.com/photo-1591637333526-959307f88f5e?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
    defaultWidth: 60,
    defaultHeight: 40
  },
  {
